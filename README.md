...
🐓 [Kai / SlothKai](https://github.com/SlothKai) - Heatmap Visualization, User-Interface Implementation, Histogram Preparation<br>
🐣 [Fraser / FCWX](https://github.com/Fcwx) - HTTP implementation, Basic Visualization, Slides and Video Editing<br>
